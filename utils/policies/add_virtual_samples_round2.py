...
path_to_read = ['RB_dataset/', 'RB_dataset_r2_' + data_from + "/"]
path_to_save = 'RB_dataset_r2_' + data_from + "/"
if pick:
    filename = ["rl_dataset.csv", "rl_dataset_train_left.csv"]
    ...
    filename = ["rl_dataset.csv", "rl_dataset.csv"]
...
def main():
    ...
    for i in range(len(path_to_read)):
        dataset.append(pd.read_csv(os.path.join(path_to_read[i], filename[i])))
    ...
    if os.path.exists(os.path.join(path_to_save, filename_add_missing)):
        os.remove(os.path.join(path_to_save, filename_add_missing))
    dataset.to_csv(os.path.join(path_to_save, filename_add_missing), index=False)
    ...
    if bootstrapping:
        ...
        if os.path.exists(os.path.join(path_to_save, filename_add_missing_bootstrapping)):
            os.remove(os.path.join(path_to_save, filename_add_missing_bootstrapping))
        dataset.to_csv(os.path.join(path_to_save, filename_add_missing_bootstrapping), index=False)
