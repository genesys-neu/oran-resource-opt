...
while [ $experiments -le 10 ]; do
  ...
  while [ $trial -le 10 ]; do
    ...
    if [ $trial -eq 1 ]; then
        ...
        sshpass -p "scope" ssh $gnb "echo '1110000000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_0.txt"
        sshpass -p "scope" ssh $gnb "echo '0001111110000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_1.txt"
        sshpass -p "scope" ssh $gnb "echo '0000000001111111110000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_2.txt"
        ...
        sshpass -p "scope" ssh $gnb "echo '1110000000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_0.txt"
        sshpass -p "scope" ssh $gnb "echo '0001111100000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_1.txt"
        sshpass -p "scope" ssh $gnb "echo '0000000011111111110000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_2.txt"
        ...
        sshpass -p "scope" ssh $gnb "echo '1110000000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_0.txt"
        sshpass -p "scope" ssh $gnb "echo '0001111000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_1.txt"
        sshpass -p "scope" ssh $gnb "echo '0000000111111111110000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_2.txt"
        ...
        sshpass -p "scope" ssh $gnb "echo '1100000000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_0.txt"
        sshpass -p "scope" ssh $gnb "echo '0011111110000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_1.txt"
        sshpass -p "scope" ssh $gnb "echo '0000000001111111110000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_2.txt"
        ...
        sshpass -p "scope" ssh $gnb "echo '1100000000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_0.txt"
        sshpass -p "scope" ssh $gnb "echo '0011111100000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_1.txt"
        sshpass -p "scope" ssh $gnb "echo '0000000011111111110000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_2.txt"
        ...
        sshpass -p "scope" ssh $gnb "echo '1100000000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_0.txt"
        sshpass -p "scope" ssh $gnb "echo '0011111000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_1.txt"
        sshpass -p "scope" ssh $gnb "echo '0000000111111111110000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_2.txt"
        ...
        sshpass -p "scope" ssh $gnb "echo '1100000000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_0.txt"
        sshpass -p "scope" ssh $gnb "echo '0011110000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_1.txt"
        sshpass -p "scope" ssh $gnb "echo '0000001111111111110000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_2.txt"
        ...
        sshpass -p "scope" ssh $gnb "echo '1000000000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_0.txt"
        sshpass -p "scope" ssh $gnb "echo '0111111110000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_1.txt"
        sshpass -p "scope" ssh $gnb "echo '0000000001111111110000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_2.txt"
        ...
        sshpass -p "scope" ssh $gnb "echo '1000000000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_0.txt"
        sshpass -p "scope" ssh $gnb "echo '0111111100000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_1.txt"
        sshpass -p "scope" ssh $gnb "echo '0000000011111111110000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_2.txt"
        ...
        sshpass -p "scope" ssh $gnb "echo '1000000000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_0.txt"
        sshpass -p "scope" ssh $gnb "echo '0111111000000000000000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_1.txt"
        sshpass -p "scope" ssh $gnb "echo '0000000111111111110000000' > /root/radio_code/scope_config/slicing/slice_allocation_mask_tenant_2.txt"
    fi
