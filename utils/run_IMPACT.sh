...
# TODO: update the line below to add or remove _ul for future ul/dl based interference
...
# TODO: choose UL or DL listener
# downlink
# sshpass -p "sunflower" ssh $listener "sed -i 's/--freq 1\.010e9 --rate 1e6/--freq 0.980e9 --rate 2e7/' utils/uhd_rx_fft.sh"
# uplink
